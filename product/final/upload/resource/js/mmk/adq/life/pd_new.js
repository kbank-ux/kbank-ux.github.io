$(function () {
    ...
    var section05 = function () {
        gsap.set(['.ui-life-section05-title-block01', '.ui-life-section05-title-block02', '.life-section05-subtext', '.ui-lottie-life-section05-dial'], {
            y: 50,
            opacity: 0,
        });
        ...
        gsap.timeline({
            ...
            .to(['.ui-life-section05-title-block01', '.ui-life-section05-title-block02', '.life-section05-subtext', '.ui-lottie-life-section05-dial'], {
                y: 0,
                opacity: 1,
                stagger: {
                    amount: 1,
    ...
    var section06 = function () {
        gsap.set(['.ui-life-section06-title-block01', '.ui-life-section06-title-block02', '.life-section06-subtext', '.ui-life-section06-calendar', '.ui-life-section06-button-link'], {
            y: 50,
            opacity: 0,
        });
        ...
        gsap.timeline({
            ...
            .to(['.ui-life-section06-title-block01', '.ui-life-section06-title-block02', '.life-section06-subtext', '.ui-life-section06-calendar', '.ui-life-section06-button-link'], {
                y: 0,
                opacity: 1,
                stagger: {
                    amount: 0.5,
